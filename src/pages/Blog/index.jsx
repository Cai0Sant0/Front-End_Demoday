        ...
        <div id="blogs">
          <div className="ConsultaOftalmo" id="contentBlogs">
            ...
            <div className="primeiroPost" id="backgroundBlogs">
              ...
              <p id="paragraphBlogs">
                Os pais devem estar atentos a certos comportamentos que podem
                indicar problemas de visão nas crianças.
              </p>
              <div id="btnLerMais1">
                <LerMais />
              </div>
          ...
          <div className="ConsultaOftalmo" id="contentBlogs">
            <div className="segundoPost" id="backgroundBlogs">
              <h3 id="titleBlogs">
                A Importância da luz natural para a visão das crianças:
              </h3>
              <p id="paragraphBlogs">
          ...
          <div className="ConsultaOftalmo" id="contentBlogs">
            ...
            <div className="terceiroPost" id="backgroundBlogs">
              <h3 id="titleBlogs">
                Dicas para criar um ambiente favorável à saúde ocular em casa
              </h3>
              <p id="paragraphBlogs">
                Manter a iluminação adequada em casa é crucial, especialmente
                durante atividades que exigem concentração visual.
              </p>
              <div id="btnLerMais3">
                <LerMais3 />
              </div>
          ...
          <div className="ConsultaOftalmo" id="contentBlogs">
            <div className="quartoPost" id="backgroundBlogs">
              <h3 id="titleBlogs">
                Jogos e atividades para estimular a saúde ocular
              </h3>
              <p id="paragraphBlogs">
                A exposição à luz natural é fundamental para o desenvolvimento
                saudável da visão.
          ...
          <div className="ConsultaOftalmo" id="contentBlogs">
            ...
            <div className="quintoPost" id="backgroundBlogs">
              <h3 id="titleBlogs">
                Como escolher a armação de óculos ideal para seu filho
              </h3>
              <p id="paragraphBlogs">
                A escolha da armação dos óculos pode ser uma tarefa divertida!
              </p>
              <div id="btnLerMais5">
                <LerMais5 />
              </div>
          ...
          <div className="ConsultaOftalmo" id="contentBlogs">
            <div className="sextoPost" id="backgroundBlogs">
              <h3 id="titleBlogs">
                Mitos e Verdades sobre a Saúde Ocular Infantil
              </h3>
              <p id="paragraphBlogs">
                Existem muitos mitos sobre a saúde ocular que podem gerar
                confusão.
              </p>
              <div id="btnLerMais6">
                <LerMais6 />
